...
### 3.1 カレンダー表示機能 (src/ui/components/calendar.ts)
- [ ] Calendar コンポーネント作成
- [ ] カレンダーライブラリ選定・導入
- [ ] 月表示カレンダー実装
- [ ] 日付選択機能
...
### 3.3 添付ファイル処理 (src/core/attachment-manager.ts)
- [ ] AttachmentManager クラス作成
- [ ] 添付ファイルパス解決
- [ ] 画像添付対応 (プレビュー表示)
- [ ] ファイル添付対応 (リンク表示)
- [ ] 添付ファイルコピー機能
...
### 4.3 キャッシュ最適化 (src/core/cache-manager.ts)
- [ ] CacheManager クラス作成
- [ ] メモリスト読み込みキャッシュ
- [ ] カテゴリ設定キャッシュ
- [ ] キャッシュ無効化ロジック (ファイル変更検知)
- [ ] LRUキャッシュ実装
