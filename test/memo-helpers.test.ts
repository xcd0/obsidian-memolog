...
describe("memo-helpers", () => {
	...
	describe("parseMetadata", () => {
		test("基本的なメタデータ抽出", () => {
			const text = "<!-- memo-id: test-123, timestamp: 2025-10-23T14:30:45.000Z, category: \"work\" -->\n内容"
	...
	describe("removeFlagFromHeader", () => {
		test("ヘッダーからフラグを削除", () => {
			const text = "<!-- memo-id: test-123, timestamp: 2025-10-23T14:30:45.000Z, deleted: \"true\" -->\n内容"
...
メモの内容`
		...
		test("テンプレート付きメモのパース", () => {
			const text =
				`<!-- memo-id: test-123, timestamp: 2025-10-30T14:30:45.000Z, category: "work", template: "# %Y-%m-%d\\n{{content}}" -->
# 2025-10-30
メモの内容`
		...
		test("{{content}}プレースホルダー付きテンプレートのパース", () => {
			const text =
				`<!-- memo-id: test-123, timestamp: 2025-10-30T14:30:45.000Z, category: "work", template: "Before{{content}}After" -->
Before
実際のメモ内容
After`
		...
		test("削除フラグ付きメモのパース", () => {
			const text =
				`<!-- memo-id: test-123, timestamp: 2025-10-30T14:30:45.000Z, category: "work", deleted: "true", trashedAt: "2025-10-31T10:00:00.000Z" -->
## 2025-10-30 14:30
メモの内容`
