...
describe("一週間フィルターの重複バグ検証", () => {
	...
	// ! 同じメモID(重複)を持つメモ。
	const duplicateMemo =
		`<!-- memo-id: duplicate-memo-id, timestamp: 2025-10-30T05:00:00.000Z, category: "work", template: "{{content}}" -->
重複メモ
`

	// ! ファイル1（2025-10-25）: 古いメモ。
	const file1Content =
		`<!-- memo-id: memo-2025-10-25, timestamp: 2025-10-25T05:00:00.000Z, category: "work", template: "{{content}}" -->
10/25のメモ
`
